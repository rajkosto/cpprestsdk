...
namespace details
{
    ...
    public:
        ...
        _M_exceptionObserved(0), _M_stdException(_E), _M_stackTrace(_stackTrace), m_datarace_tracing(0)
#if defined (__cplusplus_winrt)
        ...
        _M_exceptionObserved(0),  _M_winRTException(_E), _M_stackTrace(_stackTrace), m_datarace_tracing(0)
        {
        }
#endif  /* defined (__cplusplus_winrt) */
        ...
        ~_ExceptionHolder()
        {
            auto traceval = atomic_exchange(m_datarace_tracing, -1);
            if (traceval != 0)
                std::abort();
        ...
        {
            auto readers = ++m_datarace_tracing;
            if (readers <= 0)
                std::abort();

            if (_M_exceptionObserved == 0)
            {
                _M_exceptionObserved.store(1);
            }
    ...
    private:
        ...
        std::atomic<int> m_datarace_tracing;
    };
